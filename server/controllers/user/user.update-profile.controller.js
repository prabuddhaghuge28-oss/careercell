...
const UpdateProfile = async (req, res) => {
  ...
  try {
    ...
    if (req.body.studentProfile && req.body.studentProfile.ABCID !== undefined) {
      if (await User.findOne({ 'studentProfile.ABCID': req.body.studentProfile.ABCID }) !== null)
        return res.status(400).json({ msg: "ABCID is Already Exist, Please Enter Correct ABCID!" });
    }
    ...
    if (user.role === "student" && req.body.studentProfile) {
      ...
      if (req.body.studentProfile.ABCID) user.studentProfile.ABCID = req.body.studentProfile.ABCID;
      ...
      if (req.body.studentProfile.pastQualification) {
        ...
        if (req.body.studentProfile.pastQualification.hsc) {
          if (req.body.studentProfile.pastQualification.hsc.board && req.body.studentProfile.pastQualification.hsc.board !== "undefined") {
            user.studentProfile.pastQualification.hsc.board = req.body.studentProfile.pastQualification.hsc.board;
          }
          if (req.body.studentProfile.pastQualification.hsc.year && req.body.studentProfile.pastQualification.hsc.year !== "undefined") {
            user.studentProfile.pastQualification.hsc.year = req.body.studentProfile.pastQualification.hsc.year;
          }
          if (req.body.studentProfile.pastQualification.hsc.percentage && req.body.studentProfile.pastQualification.hsc.percentage !== "undefined") {
