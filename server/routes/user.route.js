...
// unified login controller for all roles
const UnifiedLogin = require('../controllers/user/unified.login.controller.js');
...
// unified login endpoint: accepts email/password for student, tpo_admin, management_admin
