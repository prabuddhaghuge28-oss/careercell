...
function LoginTPO() {
  document.title = 'CarrerCell | TPO Login';
      ...
      <div className="relative flex justify-center items-center min-h-screen bg-gradient-to-br from-primary-50 via-surface-soft to-primary-100">
        ...
        <form className="form-signin flex justify-center items-center flex-col gap-4 backdrop-blur-xl bg-white/70 border border-white/40 rounded-2xl p-8 md:p-10 shadow-soft w-[92%] sm:w-[80%] md:w-[500px]" onSubmit={handleSubmit}>
          <div className='flex justify-center items-center flex-col text-center'>
            ...
            <h1 className="text-xl md:text-2xl font-semibold text-gray-800">TPO Login</h1>
            <p className="text-sm text-gray-500 mt-1">Manage company postings and student applications</p>
          </div>
          ...
          <span className='text-center text-sm text-gray-600'>Log In as Management?
            <span className='text-primary-700 font-semibold cursor-pointer px-1 hover:underline' onClick={() => navigate('../management/login')}>
              Click Here
            </span>
          </span>
        </form>
