...
function ViewlAllNotice() {
  document.title = 'CarrerCell | Notices';
              ...
              <Table striped bordered hover className='bg-white my-6 rounded-lg shadow w-full text-base max-sm:text-sm'>
                ...
                <tbody>
                  {noticesData?.length > 0 ? (
                          ...
                          currentUser?.role !== 'student' && (
                            <>
                              <td>
                                ...
                                {notice?.sender_role === 'system' && 'System'}
                                {notice?.sender_role === 'student' && 'Student'}
                              </td>
                              <td>
                    ...
                    <tr>
                      <td colSpan={currentUser?.role !== 'student' ? "7" : "5"}>No notices found!</td>
                    </tr>
                  )}
                </tbody>
              </Table>
