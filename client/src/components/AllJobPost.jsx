...
function AllJobPost() {
  document.title = 'CareerCell | Job Listings';
                          ...
                          >
                            ...
                            <td>
                              <div className="flex justify-around items-center">
                                  ...
                                  >
                                    <i
                                      ...
                                      onClick={() => {
                                        ...
                                        const destination = rolePaths[currentUser.role];
                                ...
                                {
                                  // Only TPO admins can edit or delete job posts. Management users will only view listings.
