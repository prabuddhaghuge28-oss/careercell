...
import UploadResult from './Students/UploadResult';
import { BASE_URL, SERVER_BASE_URL } from '../config/config';

function UserDetails() {
  document.title = 'CareerCell | Complete Profile';
  ...
  const fetchCurrentUserData = async () => {
    try {
      ...
      // In complete-profile mode, also update userData with the same response
  ...
  useEffect(() => {
    // Only fetch student data if not in complete-profile mode (complete-profile uses fetchCurrentUserData)
    if (!completeProfileReq) {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="px-2 py-3 flex flex-col items-center gap-4 my-1">
                      <Col className="w-32 md:w-44 lg:w-52">
                        <Image src={SERVER_BASE_URL + userData?.profile} roundedCircle />
                      </Col>
                    ...
                    <>
                      ...
                      <div className="backdrop-blur-md bg-white/30 border border-white/20 rounded-lg shadow shadow-red-400 p-6 my-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3">
                          <div className="px-2 py-3 flex flex-col gap-3">
                            <FloatingLabel controlId="floatingABCID" label="ABCID" >
                                <Form.Control
                                  type="text"
                                  placeholder="ABCID"
                                  name='ABCID'
                                  ...
                                  value={userData?.studentProfile?.ABCID}
                                  required={completeProfileReq}
                                  disabled={!completeProfileReq}
                                />
                              </FloatingLabel>
                            ...
                            <div className=" py-3 flex flex-wrap gap-1">
                              ...
                              <div className="flex flex-col gap-1">
                                ...
                                <UploadResult 
                                  ...
                                  currentUser={completeProfileReq ? currentUserData : { id: userData?._id }}
                                  resultFile={userData?.studentProfile?.resultFiles?.sem6}
                                />
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3">
                          <div className="px-2 py-3 flex flex-col gap-2">
                            ...
                            <UploadResult 
                              ...
                              fetchCurrentUserData={fetchCurrentUserData}
                              currentUser={completeProfileReq ? currentUserData : { id: userData?._id }}
                              resultFile={userData?.studentProfile?.resultFiles?.ssc}
                            />
                          ...
                          <div className="px-2 py-3 flex flex-col gap-2">
                            ...
                            <UploadResult 
                              ...
                              fetchCurrentUserData={fetchCurrentUserData}
                              currentUser={completeProfileReq ? currentUserData : { id: userData?._id }}
                              resultFile={userData?.studentProfile?.resultFiles?.hsc}
                            />
                          ...
                          <div className="px-2 py-3 flex flex-col gap-2">
                            ...
                            <UploadResult 
                              ...
                              fetchCurrentUserData={fetchCurrentUserData}
                              currentUser={completeProfileReq ? currentUserData : { id: userData?._id }}
                              resultFile={userData?.studentProfile?.resultFiles?.diploma}
                            />
                          </div>
                        </div>
                      </div>
