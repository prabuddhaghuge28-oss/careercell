...
function SendNotice() {
  document.title = 'CarrerCell | Send Notice';
  ...
  // Submit form
  const handleSubmit = () => {
    // require receiver_role, title and message
          ...
          <div className="">
            <div className="my-8 backdrop-blur-md bg-white/30 border border-white/20 rounded-lg shadow shadow-red-400 p-6 max-sm:text-sm max-sm:p-3">
              <div className="grid grid-cols-2 gap-2">
                ...
                {/* Receiver Role (role-specific options) */}
                {(currentUser?.role === 'management_admin' || currentUser?.role === 'tpo_admin') && (
                  <FloatingLabel
